...
def write_output(concatenated,outpath,outname):
    with open(outpath + "/" + outname + "_reads_concatenated.tab","w") as fw:
...
def main():
    ...
    write_output(concatenated,outpath=parameters.outpath,outname=parameters.outname)
