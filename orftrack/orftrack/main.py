...
def main():
    ...
    orftrack.mapping(gff_data=gff_data, param=param)

    # Print a brief summary of ORFs mapping
    orftrack.summary(gff_outfile=param.outfile+'.gff')
