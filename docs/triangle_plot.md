#  Triangle Plot for Ribosome Profilinf Data

## **Overview**  
This script is an additional tool for **ORFribo** that visualizes periodicity and translation efficiency in ribosome profiling data.  
