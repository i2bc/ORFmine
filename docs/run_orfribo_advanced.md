...
We recall that the config.yaml file must be [completed](./Run_orfribo.md) and stored in the /workdir/ directory of the container. One should note that the same parameters will be applied to all datasets.
