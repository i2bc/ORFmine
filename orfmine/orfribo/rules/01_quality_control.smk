...
rule Init_multiqc:
    ...
    output:
        report_dir = directory(str(DATA_PROCESSING_PATH / "Quality_control" / "Before_Trimming" / "multiqc_results" )),
        report_file = str(DATA_PROCESSING_PATH / "Quality_control" / "Before_Trimming" / "multiqc_results" / "multiqc_report.html")
    log:
    ...
    params:
        str(DATA_PROCESSING_PATH / "Quality_control" / "Before_Trimming" / "multiqc_results" / "multiqc_data")
    shell:
        """
